...
class AStar(object):
    ...
    def init_grid(self):
        walls = ((0, 3), (0, 4), (1, 5), (2, 0), (2, 2), (2, 4), (2, 4), (3, 0), (3, 2), (3, 3), (4, 0),(5,0), (5,1), (5,2), (5,4))
    ...
    def get_heuristic(self, cell):
        ...
        """
        return  pow(pow((cell.x - self.end.x),2) + pow((cell.y - self.end.y),2),1/2) #calculado heuristica
    ...
    def function_Coste(self,adj,cell):
        if(adj.x == cell.x and adj.y < cell.y ):
            return 4
        elif(adj.x == cell.x and adj.y > cell.y):
            return 3
        else: 
            return 2
            ...
            for adj_cell in adj_cells:
                if adj_cell.reachable and adj_cell not in self.closed:
                    if (adj_cell.f, adj_cell) in self.opened:
                        ...
                        # for this adj cell.
                        if adj_cell.g > cell.g + self.function_Coste(adj, cell):
